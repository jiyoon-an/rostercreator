    		...
    		<div class="col-xs-6">
    	    	<div style="padding:10px;">
					<div style="padding-bottom:10px;">
						...
						<div style="display:inline;float:right;padding-right:15px;"><a style="font-size:20px;" onclick="parent.changeCSS('freeBoard')" href="../freeBoard/vwFreeBoard.php?flag=0">More</a></div>
					</div>
					<?php
